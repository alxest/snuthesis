...
The two state-of-the-art frameworks supporting modular verification of a multi-language program, CompCertX and Compositional CompCert,  %% heterogeneous systems
...
We show that RUSC can solve the problem without any restrictions but still with
low verification overhead. For this, we develop CompCertM, a full
extension of %% the latest version of
CompCert supporting multi-language
