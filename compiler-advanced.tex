...
See \Cref{sec:compiler:related} for comparison with \cite{DBLP:conf/icfp/DreyerNB10,pb}.}
...
We give examples using module-local invariants in \Cref{sec:compiler:advanced:unreadglob,sec:program:solution}.
