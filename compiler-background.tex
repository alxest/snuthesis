...
However, the flat memory model does not properly model buffer overrun as UB, and thus it cannot validate essential compiler translations.
...
With a logical memory model, the above translation is valid.
