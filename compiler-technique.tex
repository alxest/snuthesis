...
Intuitively, mode (2) imposes strong restriction on the target and no restriction on source, where mode (3) imposes moderate restriction on both source and target.
