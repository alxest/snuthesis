...
\section{Register (tentative)}\label{sec:overview:register}
...
\section{Proof}\label{sec:overview:proof}
...
%Then have a final paragraph or section: "Summary of Contributions". It should list the major contributions
...
%% %about previous work right away. In this case Related Work can be either a section at the end of the
