...
in the PhD thesis of \cite{StewartThesis} (see \Cref{sec:compiler:related} for comparison).}
...
discussed in \Cref{sec:compiler:problems}. Finally, we
...
We will give a more comprehensive comparison and discuss future research directions in \Cref{sec:program:solution,sec:program:future}.
